	   ...
	   public void doPost(HttpServletRequest request,HttpServletResponse response)
		 ...
		 String houseNum =   request.getParameter("houseNum");
		   ...
		   try {
			   ...
			   if(houseNum!=null) //查询
				   rs = sql.executeQuery("SELECT * FROM ProInformation where 房屋号='"+houseNum+"'");
				   		   			   
			   else    
				   rs = sql.executeQuery("SELECT * FROM ProInformation");	
		       ...
		       RequestDispatcher dispatcher = 
				       request.getRequestDispatcher("viewhouse.jsp");
