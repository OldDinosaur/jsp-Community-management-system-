...
<body bgcolor=cyan onload="getData()"><div align="center">
 <br>
 <form action="viewhouseServlet" method=post id="formid"><input type="submit" name="b" value="刷新"></form>
 <br>当前显示的内容是：
 ...
 <%
  ...
  if(totalPages>=1){
      ...
      for(int i=index;i<pageSize +index;i++){
    	  ...
    	  //删除
 	      String del="<form action='deletehouseServlet' method='post'>"+
	    		  "<input type='hidden' name='delete' value="+table[i][0]+">"+"<input type='submit' value='删除'></form>";	    		 
    	  out.print("<td>"+del+"</td>");
    	  //修改
 	      String alter="<form action='alterhouseServlet' method='post'>"+
